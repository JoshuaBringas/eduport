...
<div class="login-container" style="background-image: url(uploads/bg1.png); background-repeat: no-repeat; background-position: center; background-size: cover;">
		...
		<div class="login-content">
			...
			<form method="post" role="form" id="form_login">
				...
				<div class="form-group">
					...
					<input type="checkbox" value="" required="checkbox" name="checkbox" style="height: 20px; width: 20px; font-size: 20px; color: black;">Agree the Terms and Conditions</input>
			</form>
			
			<div class="login-bottom-links">
				<A style="color:black; font-size: 20px; A:hover: green;" href="<?php echo base_url();?>index.php?login/forgot_password" class="link">
